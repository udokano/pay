		...
		<div class="entry">
			...
			<div id="customer-info">
				...
				<div class="usccart_navi">
					...
					<li class="ucart uscdelivery">お支払い情報</li>
			...
			<?php if (usces_is_membersystem_state()) : ?>
				...
				<form action="<?php usces_url('cart'); ?>" method="post" name="customer_loginform" onKeyDown="if (event.keyCode == 13) {return false;}" class="mb50">
