					...
					<form action="<?php usces_url('member'); ?>#edit" method="post" onKeyDown="if (event.keyCode == 13) {return false;}">
						<table class="customer_form" id="customer_form">
							...
							<tr>
								...
								<td colspan="2"><input class="hidden" value=" " /><input name="member[password1]" class="w50" id="password1" type="password" value="<?php usces_memberinfo('password1'); ?>" autocomplete="off" />
