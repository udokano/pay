...
<form action="<?php echo USCES_CART_URL ?>" method="post" id="form">
  <header class="key__visual">
    <div class="content">
      <div class="key__visual__texts">
        ...
        <p class="cach__text">定額で指定の施術が何度でも受けられるサービスです。<br>
          プランにない施術でも別途ご相談可能ですので、お気軽にスタッフまでご相談ください。</p>
      </div>
      <!-- ./key__visual__texts -->
    ...
    <div class="shop__select__area" id="select__shop">
      <div class="select__wrap">
        ...
        <?php echo usces_the_itemOption("ご利用クリニック");?> </div>
      <!-- ./select__wrap -->
    </div>
    <!-- ./shop__select__area -->
  ...
  <div id="radio__out"> <?php echo usces_the_itemOption("コース選択");?> </div>
